...
\*\*GH\_XcelCanvas\*\* is a custom plugin for Grasshopper (Rhino 3D) designed to render Excel spreadsheets directly onto the Canvas. 
...
\*\*GH\_XcelCanvas\*\* é um plugin para Grasshopper (Rhino 3D) desenvolvido para renderizar planilhas do Excel diretamente no Canvas.
